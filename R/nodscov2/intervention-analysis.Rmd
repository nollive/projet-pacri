...
p_grid <- ggplot(all_metrics , aes(x = beta, y = SAR_median, color = as.factor(nu), group = nu)) +
  geom_line() +
  geom_point() +
  geom_hline(yintercept = 0.2, linetype = "dashed", color = "darkgrey") +
  annotate("rect", xmin = -Inf, xmax = Inf, ymin = 0.2, ymax = 0.3, alpha = 0.3, fill = "lightgrey") +
...
seir_metrics <- get_all_SEIR_metrics(list_SEIR = list_SEIR)


plot_SEIR_n(couple = couple, list_SEIR = list_SEIR, all_SEIR_metrics = seir_metrics)
```
