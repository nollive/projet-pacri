...
counts_df <- SEIR_counts(status_sim, n_subdivisions, n_individual)
```
...
print(SEIR_n)
ggsave(file = file.path(fig_sim_path, 'SEIR', paste0(id_sim, "-SEIR-n.png")), plot = SEIR_n, height = 4, width = 20)
