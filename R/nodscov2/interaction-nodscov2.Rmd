...
k_RP %>% filter(from_status == "PA" & to_status == "PA") %>% group_by(from) %>% summarise(len = sum(length))
# 001-0038-B-S - 6670s --> why?
# 001-0127-B-A - 109770s = 30.49167 hour out of 39.78888hours --> same room? (valid)
